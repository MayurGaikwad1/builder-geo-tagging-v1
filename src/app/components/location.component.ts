      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          ...
          <p class="text-secondary-600 mt-2">
            Monitor and manage your location tracking data
          </p>
        </div>
        ...
        <div class="card p-6 mb-8" *ngIf="!hasConsent()">
          <div class="flex items-start">
            ...
            <div class="ml-3 flex-1">
              <h3 class="text-lg font-medium text-warning-800">
                Location Consent Required
              </h3>
              <div class="mt-2 text-sm text-warning-700">
                <p>
                  To enable location tracking, we need your permission to access
                  your device's location. This helps us:
                </p>
              ...
              <div class="mt-4">
                <button (click)="requestConsent()" class="btn btn-warning mr-3">
                  Grant Location Permission
                </button>
                <button (click)="showPrivacyInfo()" class="btn btn-secondary">
                  Privacy Information
                </button>
              </div>
            </div>
        ...
        <div class="card p-6 mb-8" *ngIf="hasConsent()">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-secondary-600">
                You have granted permission for location tracking
              </p>
              <p class="text-xs text-secondary-400">
                Granted on: {{ consentDate() }}
              </p>
            </div>
            <button (click)="revokeConsent()" class="btn btn-danger">
              Revoke Consent
            </button>
          </div>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-4">
              <span class="text-sm text-secondary-600"
                >{{ locationHistory().length }} records</span
              >
              <button
          ...
          <div *ngIf="locationHistory().length === 0" class="text-center py-8">
            ...
            <p class="mt-1 text-sm text-secondary-500">
              Start location tracking to see your history here.
            </p>
          </div>
            ...
            <div class="overflow-x-auto">
              <table class="min-w-full divide-y divide-secondary-200">
                ...
                <tbody class="bg-white divide-y divide-secondary-200">
                  <tr
                    *ngFor="
                      let location of locationHistory();
                  ...
                  >
                    ...
                    <td
                      class="px-6 py-4 whitespace-nowrap text-sm text-secondary-500 font-mono"
                    >
                      {{
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <span
                        [class]="getLocationTypeClass(location.userInitiated)"
                      >
...
export class LocationComponent implements OnInit {
  ...
  async requestConsent() {
    ...
    if (!permissionStatus.supported) {
      alert(
        "Location services are not supported by your browser. Please use a modern browser with location support.",
      );
      return;
    }
  ...
  revokeConsent() {
    if (
      confirm(
        "Are you sure you want to revoke location consent? This will stop all location tracking.",
      )
    ) {
