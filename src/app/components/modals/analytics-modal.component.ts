...
@Component({
  ...
  template: `
    <div class="fixed inset-0 z-50 overflow-y-auto" [class.hidden]="!modalService.isModalOpen('analytics')">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-7xl sm:w-full">
          ...
          <div class="bg-white px-6 py-4 border-b border-secondary-200">
            <div class="flex items-center justify-between">
              <h3 class="text-lg font-semibold text-secondary-900">Analytics Dashboard</h3>
              <div class="flex items-center space-x-4">
                <!-- Export buttons -->
                <div class="flex gap-2">
                  <button (click)="exportData('excel')" class="btn btn-secondary btn-sm">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Excel
                  </button>
                  <button (click)="exportData('csv')" class="btn btn-secondary btn-sm">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="bg-secondary-50 px-6 py-4 border-b border-secondary-200">
            <div class="flex flex-wrap items-center gap-4">
              <div>
                <label class="block text-sm font-medium text-secondary-700 mb-1">Date Range</label>
                <div class="flex items-center gap-2">
                  ...
                  >
                    <span *ngIf="analyticsService.isLoading()" class="inline-block animate-spin rounded-full h-3 w-3 border-b-2 border-white mr-1"></span>
                    Update
                  </button>
                </div>
              </div>
          ...
          <!-- Content -->
          <div class="bg-white px-6 py-6 max-h-96 overflow-y-auto" id="analytics-content">
            <!-- Overview Tab -->
            <div *ngIf="activeTab === 'overview'" class="space-y-6">
              <!-- KPI Cards -->
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" *ngIf="performanceKPIs">
                <div class="card p-4">
                  <div class="flex items-center">
                    <div class="flex-1">
                      <p class="text-sm font-medium text-secondary-600">Overall Performance</p>
                      <p class="text-2xl font-bold" [class]="getGradeColor(performanceKPIs.overallPerformanceGrade)">
                ...
                <div class="card p-4">
                  <div class="flex items-center">
                    <div class="flex-1">
                      ...
                      <p class="text-2xl font-bold text-secondary-900">{{ performanceKPIs.activityScore.toFixed(1) }}%</p>
                    </div>
                ...
                <div class="card p-4">
                  <div class="flex items-center">
                    <div class="flex-1">
                      ...
                      <p class="text-2xl font-bold text-secondary-900" *ngIf="complianceMetrics">{{ complianceMetrics.overallScore.toFixed(1) }}%</p>
                    </div>
                ...
                <div class="card p-4">
                  <div class="flex items-center">
                    <div class="flex-1">
                      ...
                      <p class="text-2xl font-bold text-secondary-900" *ngIf="meetingAnalytics">{{ meetingAnalytics.completionRate.toFixed(1) }}%</p>
                    </div>
              ...
              <!-- Performance Chart -->
              <div class="card p-4">
                <h4 class="text-lg font-semibold text-secondary-900 mb-4">Performance Trend</h4>
                <div class="h-48">
            ...
            <div *ngIf="activeTab === 'location'" class="space-y-6">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" *ngIf="locationAnalytics">
                <!-- Location Stats -->
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Location Statistics</h4>
                  <div class="space-y-3">
                ...
                <!-- Location Chart -->
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Daily Location Trend</h4>
                  <div class="h-48">
            ...
            <div *ngIf="activeTab === 'branch'" class="space-y-6">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" *ngIf="branchAnalytics">
                <!-- Branch Stats -->
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Branch Activity Statistics</h4>
                  <div class="space-y-3">
                    <div class="flex justify-between">
                ...
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Branch Compliance</h4>
                  <div class="h-48">
            ...
            <div *ngIf="activeTab === 'meetings'" class="space-y-6">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" *ngIf="meetingAnalytics">
                <!-- Meeting Stats -->
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Meeting Statistics</h4>
                  <div class="space-y-3">
                    <div class="flex justify-between">
                ...
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Meeting Status Distribution</h4>
                  <div class="h-48">
            ...
            <div *ngIf="activeTab === 'compliance'" class="space-y-6">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" *ngIf="complianceMetrics">
                <!-- Compliance Overview -->
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Compliance Overview</h4>
                  <div class="space-y-3">
                    <div class="flex justify-between">
                ...
                <!-- Compliance Chart -->
                <div class="card p-4">
                  <h4 class="text-lg font-semibold text-secondary-900 mb-4">Compliance Breakdown</h4>
                  <div class="h-48">
