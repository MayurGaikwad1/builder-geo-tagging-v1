...
@Component({
  ...
  template: `
    <div
      ...
      [class.hidden]="!modalService.isModalOpen('location')"
    >
      <div
          ...
          <div class="bg-white px-6 py-6 max-h-96 overflow-y-auto">
            ...
            <div class="mb-8">
              ...
              <div
                ...
                *ngIf="locationService.permissionStatus()"
              >
                <div class="flex items-center">
                  <div class="flex-shrink-0">
                    <svg
                      class="w-5 h-5"
                      [class]="getPermissionStatusColor()"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div class="ml-3">
                    ...
                    <p
                      ...
                      *ngIf="!locationService.permissionStatus()?.canRequest"
                    >
                      Permission has been blocked. Click "Grant Location
              ...
              <div class="card p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p class="text-lg text-secondary-900">
                      {{
                        locationService.currentLocation()?.dateTime
                          | date: "medium"
                      }}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p class="text-lg text-secondary-900">
                      {{
                        locationService.currentLocation()?.accuracy?.toFixed(1)
                      }}m
                    </p>
                  </div>
                </div>
                  ...
                  <div class="flex justify-between items-start">
                    <div class="flex-1">
                      ...
                      <p class="text-sm text-secondary-600">
                        {{ location.dateTime | date: "short" }} • Accuracy:
