...
@Component({
  ...
  template: `
    <div
      ...
      [class.hidden]="!modalService.isModalOpen('partner-meet')"
    >
      <div
          ...
          <div class="bg-white px-6 py-6 max-h-96 overflow-y-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    >
                      ...
                      <option
                        *ngFor="let partner of getFilteredPartners()"
                  ...
                  <div
                    *ngIf="newMeetingData.category === 'new'"
                    class="md:col-span-2"
                  >
                    <label
                      class="block text-sm font-medium text-secondary-700 mb-2"
            ...
            <div *ngIf="activeTab() === 'meetings'" class="space-y-6">
              ...
              <div class="space-y-4">
                <div
                  *ngFor="
                    let meeting of getFilteredMeetings();
                  ...
                  <div class="flex justify-between items-start">
                    <div class="flex-1">
                      <div class="flex items-center space-x-2 mb-2">
                        <h5 class="font-semibold text-secondary-900">
                          {{ meeting.partnerName }}
                        </h5>
                        <span
                          class="status-badge"
                      ...
                      <p class="text-sm text-secondary-500">
                        ...
                        <span *ngIf="meeting.duration">
                          • Duration: {{ meeting.duration }} min</span
                        >
                      </p>
                    </div>
                    <div class="text-right">
                      <button
                        *ngIf="
                          ...
                          isToday(meeting.meetingDateTime)
                        "
                        (click)="
                          startMeeting(meeting); $event.stopPropagation()
                        "
                      ...
                      <button
                        *ngIf="meeting.status === 'in-progress'"
                        (click)="
                          completeMeeting(meeting); $event.stopPropagation()
                        "
                ...
                <div
                  *ngIf="getFilteredMeetings().length === 0"
            ...
            <div *ngIf="activeTab() === 'active'" class="space-y-6">
              ...
              <div
                *ngIf="partnerService.activeMeeting(); else noActiveMeeting"
                class="space-y-6"
              >
                <div class="card p-6">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h5 class="font-semibold text-secondary-900 mb-2">
                        {{ partnerService.activeMeeting()?.partnerName }}
                      </h5>
                      <p class="text-secondary-600 mb-1">
                        {{ partnerService.activeMeeting()?.purpose }}
                      </p>
                      <p class="text-secondary-600 mb-1">
                        {{ partnerService.activeMeeting()?.address }}
                      </p>
                      <p class="text-sm text-secondary-500">
                        Started:
                        {{
                          partnerService.activeMeeting()?.startDateTime
                            | date: "medium"
                        }}
                      </p>
                    </div>
                ...
                <div class="flex flex-wrap gap-4">
                  ...
                  <button
                    (click)="completeMeeting(partnerService.activeMeeting()!)"
            ...
            <div *ngIf="activeTab() === 'analytics'" class="space-y-6">
              ...
              <!-- Recent Activity -->
              <div>
                <h5 class="font-medium text-secondary-900 mb-3">
                  Recent Activity
                </h5>
                <div class="space-y-3">
                  <div
                    *ngFor="
                      let meeting of getRecentMeetings();
                      trackBy: trackByMeeting
                    "
                  ...
                  >
                    ...
                    <div class="text-right">
                      ...
                      <p class="text-xs text-secondary-500 mt-1">
                        {{ meeting.meetingDateTime | date: "short" }}
                      </p>
                    </div>
                  </div>
                </div>
    ...
    return this.partnerService
      ...
      .filter(
        (p) =>
          ...
          p.subCategory === this.newMeetingData.subCategory,
      );
  }
  ...
  async scheduleMeeting() {
    try {
      const meetingDateTime = new Date(
        `${this.newMeetingData.date}T${this.newMeetingData.time}`,
      );
      const currentLocation = this.locationService.currentLocation();
      ...
      const meetingData = {
        ...
        partnerName: this.newMeetingData.partnerAgentCode
          ? this.partnerService.getPartnerByAgentCode(
