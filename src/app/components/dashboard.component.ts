      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          <h1 class="text-3xl font-bold text-secondary-900">
            Geo-Tagging Module Dashboard
          </h1>
          <p class="text-secondary-600 mt-2">
            Field operations management and monitoring
          </p>
        </div>
        ...
        <div class="mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
              *ngFor="let tile of branchService.tiles(); trackBy: trackByTile"
              class="tile"
            ...
            >
              <div class="flex items-center justify-between mb-3">
                ...
                <span
                  class="status-badge"
                  [class]="getStatusBadgeClass(tile.status)"
                >
                  {{ getStatusText(tile.status) }}
                </span>
              </div>
              <p class="text-sm text-secondary-600 mb-2">
                Time Window: {{ tile.timeWindow.start }} -
                {{ tile.timeWindow.end }}
              </p>
        ...
        <div class="mb-8" *ngIf="locationService.currentLocation()">
          ...
          <div class="card p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <p class="text-sm font-medium text-secondary-600 mb-1">
                  Location
                </p>
              ...
              <div>
                ...
                <p class="text-lg text-secondary-900">
                  {{
                    locationService.currentLocation()?.dateTime | date: "medium"
                  }}
                </p>
              </div>
              <div>
                ...
                <p class="text-lg text-secondary-900">
                  {{ locationService.currentLocation()?.accuracy?.toFixed(1) }}m
                </p>
              </div>
            </div>
          ...
          <div class="card p-6" [class]="getLocationConsentCardClass()">
            <div class="flex items-start">
              <div class="flex-shrink-0">
                <svg
                  class="h-6 w-6"
                  [class]="getLocationConsentIconClass()"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div class="ml-3 flex-1">
                <h3
                  ...
                  [class]="getLocationConsentTextClass()"
                >
                  {{ getLocationConsentTitle() }}
                </h3>
                ...
                <div class="mt-4 flex flex-wrap gap-3">
                  <button
                    ...
                    class="btn"
                    [class]="getLocationConsentButtonClass()"
                  >
        ...
        <div class="mb-8" *ngIf="getTodayMeetingsList().length > 0">
          ...
          <div class="space-y-4">
            <div
              *ngFor="
                let meeting of getTodayMeetingsList();
        ...
        <div class="mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button
              ...
              [disabled]="!locationService.hasConsent()"
            >
              <svg
                class="w-6 h-6 mb-2"
                fill="none"
...
export class DashboardComponent implements OnInit {
  ...
  handleBranchActivity() {
    ...
    const availableTile = tiles.find(
      (tile) => tile.isVisible && tile.isEnabled,
    );
    if (availableTile) {
