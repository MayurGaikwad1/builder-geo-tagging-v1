        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
              <h1
                class="text-2xl font-bold leading-7 text-secondary-900 sm:text-3xl sm:truncate"
              >
              ...
              >
                <div class="mt-2 flex items-center text-sm text-secondary-500">
                  <svg
                    class="flex-shrink-0 mr-1.5 h-5 w-5 text-secondary-400"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button routerLink="/reports" class="card card-hover p-4 text-left">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <svg
...
export class DashboardComponent implements OnInit {
  ...
  private loadLocationData() {
    ...
    if (current) {
      ...
      this.lastLocationUpdate.set(
        new Date(current.dateTime).toLocaleTimeString(),
      );
    }
  }
