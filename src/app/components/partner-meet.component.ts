      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          ...
          <p class="text-secondary-600 mt-2">
            Schedule and manage partner meetings with geo-validation and
            tracking
          </p>
        </div>
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    [readonly]="
                      newMeetingData.category === 'existing' &&
                      newMeetingData.partnerAgentCode
                    "
              ...
              <div>
                ...
                >
                  ...
                  <option
                    *ngFor="let purpose of meetingPurposes"
                    [value]="purpose"
                  >
                    {{ purpose }}
                  </option>
              ...
              <div>
                ...
                <div class="space-y-3">
                  <div
                    *ngIf="newMeetingData.category === 'existing'"
                  ...
                  >
                    ...
                    <label
                      ...
                      >Use stored partner address</label
                    >
                  </div>
                ...
                <textarea
                  ...
                  [readonly]="
                    newMeetingData.useStoredAddress && selectedPartner()
                  "
        ...
        <div *ngIf="activeTab() === 'meetings'" class="space-y-6">
          <div class="card p-6">
            ...
            <div
              *ngIf="filteredMeetings().length === 0"
            ...
            >
              ...
              <p class="mt-1 text-sm text-secondary-500">
                Schedule your first partner meeting to get started.
              </p>
            </div>
            ...
            <div *ngIf="filteredMeetings().length > 0" class="space-y-4">
              <div
                *ngFor="let meeting of filteredMeetings()"
                class="border rounded-lg p-4 hover:bg-secondary-50"
              >
                <div class="flex items-start justify-between">
                  <div class="flex-1">
                    ...
                    <div
                      class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-secondary-600"
                    >
                      <div>
                        <p>
                          <strong>Date:</strong>
                          {{ formatMeetingDate(meeting.meetingDateTime) }}
                        </p>
                        <p><strong>Purpose:</strong> {{ meeting.purpose }}</p>
                        <p *ngIf="meeting.partnerAgentCode">
                      ...
                      <div>
                        ...
                        <p *ngIf="meeting.duration">
                          <strong>Duration:</strong>
                          {{ meeting.duration }} minutes
                        </p>
                        <p *ngIf="meeting.checkInStatus !== 'before'">
                          <strong>Check-in:</strong> {{ meeting.checkInStatus }}
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div *ngIf="activeTab() === 'active'" class="space-y-6">
          <div *ngIf="!activeMeeting()" class="card p-8 text-center">
            ...
            <p class="text-secondary-600">
              Start a scheduled meeting to see active meeting controls here.
            </p>
          </div>
          ...
          <div *ngIf="activeMeeting()" class="card p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div class="text-center p-4 bg-secondary-50 rounded-lg">
                ...
                <h3 class="font-medium text-secondary-900 mt-2">
                  Location Status
                </h3>
              ...
              <div class="text-center p-4 bg-secondary-50 rounded-lg">
                <div
                  class="h-8 w-8 bg-primary-100 rounded-full flex items-center justify-center mx-auto"
                >
                  <svg
              ...
              <div class="text-center p-4 bg-secondary-50 rounded-lg">
                ...
                <p class="text-sm text-secondary-600">
                  {{ activeMeeting()!.selfieUrl ? "Captured" : "Not taken" }}
                </p>
              </div>
            </div>
            ...
            <div
              *ngIf="activeMeeting()!.meetingCode"
              class="mb-6 p-4 bg-warning-50 border border-warning-200 rounded-lg"
            >
              <h3 class="font-medium text-warning-800 mb-2">
                Meeting Verification Code
              </h3>
              <div class="flex items-center space-x-4">
                <div class="text-2xl font-mono font-bold text-warning-900">
            ...
            <div class="flex flex-wrap gap-4">
              ...
              <button (click)="endMeetingEarly()" class="btn btn-danger">
                End Meeting Early
              </button>
            </div>
            ...
            <div class="mt-6 p-4 bg-secondary-50 rounded-lg">
              <h3 class="font-medium text-secondary-900 mb-3">
                Meeting Progress
              </h3>
              <div class="space-y-2">
            ...
            <div *ngIf="recentMeetings().length > 0" class="space-y-4">
              <div
                *ngFor="let meeting of recentMeetings()"
                class="flex items-center justify-between py-3 border-b border-secondary-200"
              >
                <div>
...
export class PartnerMeetComponent implements OnInit {
  ...
  activeTab = signal<"new-meeting" | "meetings" | "active" | "analytics">(
    "new-meeting",
  );
    ...
    switch (filter) {
      ...
      case "today":
        ...
        meetings = meetings.filter(
          (m) => new Date(m.meetingDateTime).toDateString() === today,
        );
        break;
    }
  ...
  async startMeeting(meeting: Meeting) {
    try {
      ...
      const result = await this.partnerService.startMeeting(
        meeting.meetingId,
        code,
      );
...
${meeting.remark ? `Remarks: ${meeting.remark}` : ""}`;
  ...
  async completeMeeting() {
    if (!this.canCompleteMeeting()) {
      alert(
        "Meeting cannot be completed yet. Ensure you are at the location and have met the minimum duration.",
      );
      return;
    }

    try {
      const result = await this.partnerService.completeMeeting(
        this.activeMeeting()!.meetingId,
      );
