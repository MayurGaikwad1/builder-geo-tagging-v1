      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          ...
          <p class="text-secondary-600 mt-2">
            Comprehensive reports and analytics for field operations
          </p>
        </div>
              ...
              <div class="card p-6">
                <div class="flex items-center">
                  <div class="flex-1">
                    ...
                    <p
                      class="text-3xl font-bold text-secondary-900"
          ...
          <div *ngIf="activeTab === 'location'" class="space-y-8">
            ...
            >
              ...
              <div class="card p-6">
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{ locationAnalytics.accuracyAverage.toFixed(1) }}m</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-secondary-600">User Initiated</span>
                    <span class="font-semibold">{{
                      locationAnalytics.userInitiatedCount
                    }}</span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-secondary-600">System Initiated</span>
                    <span class="font-semibold">{{
                      locationAnalytics.systemInitiatedCount
                    }}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="card p-6 lg:col-span-2">
                ...
                <div class="space-y-3">
                  <div
                    *ngFor="let location of locationAnalytics.topLocations"
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-accent-600"
                      >{{ branchAnalytics.onTimeRate.toFixed(1) }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{
                        branchAnalytics.avgHuddleDuration.toFixed(1)
                      }}
                      min</span
                    >
                  </div>
          ...
          <div *ngIf="activeTab === 'meetings'" class="space-y-8">
            ...
            >
              ...
              <div class="card p-6">
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{ meetingAnalytics.avgDuration.toFixed(1) }} min</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-secondary-600">On-time Rate</span>
                    <span class="font-semibold"
                      >{{ meetingAnalytics.onTimeRate.toFixed(1) }}%</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="card p-6 lg:col-span-2">
                ...
                <div class="space-y-3">
                  <div
                    *ngFor="let purpose of meetingAnalytics.topPurposes"
                    class="flex justify-between items-center p-3 bg-secondary-50 rounded-lg"
                  >
                    <span class="text-secondary-900">{{
                      purpose.purpose
            ...
            >
              ...
              <div class="card p-6">
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{
                        complianceMetrics.locationCompliance.toFixed(1)
                      }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{
                        complianceMetrics.branchCompliance.toFixed(1)
                      }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{
                        complianceMetrics.meetingCompliance.toFixed(1)
                      }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
              ...
              <div class="card p-6 lg:col-span-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 class="font-medium text-error-700 mb-2">
                      Policy Violations
                    </h4>
                    <div class="space-y-2">
                      <div
                        *ngFor="let violation of complianceMetrics.violations"
                        class="flex items-start"
                      >
                        <svg
                          class="w-4 h-4 text-error-500 mt-0.5 mr-2 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                  ...
                  <div>
                    <h4 class="font-medium text-success-700 mb-2">
                      Recommendations
                    </h4>
                    <div class="space-y-2">
                      <div
                        *ngFor="
                          let recommendation of complianceMetrics.recommendations
                        "
                        class="flex items-start"
                      >
                        <svg
                          class="w-4 h-4 text-success-500 mt-0.5 mr-2 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
              ...
              <div class="card p-6">
                ...
                <div class="space-y-4">
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{ performanceKPIs.activityScore.toFixed(1) }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-secondary-600">Efficiency Score</span>
                    <span class="font-semibold"
                      >{{ performanceKPIs.efficiencyScore.toFixed(1) }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-secondary-600">Punctuality Score</span>
                    <span class="font-semibold"
                      >{{ performanceKPIs.punctualityScore.toFixed(1) }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold"
                      >{{
                        performanceKPIs.geoComplianceScore.toFixed(1)
                      }}%</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-secondary-600"
                      >Meeting Effectiveness</span
                    >
                    <span class="font-semibold"
                      >{{
                        performanceKPIs.meetingEffectivenessScore.toFixed(1)
                      }}%</span
                    >
                  </div>
                </div>
  ...
  async exportData(format: "excel" | "csv" | "pdf") {
    try {
      if (format === "excel") {
        ...
        await this.analyticsService.exportToPDF(
          "dashboard-content",
          "analytics_dashboard",
        );
      }
